...
$images = @(
    @{
        Project = "FR245_310_CODE"
        Image = "artifacts/firmware/analysis/Forerunner245_310/stream_01_fw_all_bin.bin"
    },
    @{
        Project = "FR245_1370_CODE"
        Image = "artifacts/firmware/analysis/Forerunner245_1370_GUPDATE/stream_01_fw_all_bin.bin"
    }
)
...
foreach ($item in $images) {
    ...
    if ($LASTEXITCODE -ne 0) {
        throw "Ghidra analysis failed for $($item.Image)"
    }
}
